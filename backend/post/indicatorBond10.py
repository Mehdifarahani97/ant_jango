...
class Bond10(APIView):
    ...
    def get(self, request, format=None, ):
        ...
        cursor = conn.cursor()
        sql = "SELECT dates FROM bond10 ORDER BY dates desc LIMIT 1"
        cursor.execute(sql)
        ...
        if (str(rows[0]['dates'] - today)[0] != '0'):
            ...
            # 아래 두 줄은 앞에 탭을 입력하셔야 합니다...
                ...
                sql = "insert into bond10(dates, price, open, high, low, keyword) values('{}', {}, {}, {}, {}, '{}')".format(
        ...
        # 테이블 변경
        sql3 = "select * from bond10 order by dates asc"
        ...
        for n in result:
            # 테이블 변경
            sql4 = "update bond10 set changedate = {} where dates = '{}'".format(n['changedate'], n['dates'])
